...
public class RunMain {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException, ParseException {
        ...
        // 保存路径
        String path = "C:\\Users\\ddzx\\Desktop\\非现场治超\\";
        //  查询日期（开始）  年-月-日
...
//                // 下载检测单，过车照片和视频
                ...
                List<ExportVehInfo> exportVehInfo = getVehInfo(punURL, transInfoURL, siteCode, beginTime, endTime, pageNum, pageSize);
                // 当前站点没有车辆就跳出该站点
                if (exportVehInfo == null){
                    continue;
                }
                //导出超限车辆具体信息
                //ToExcel(exportVehInfo, path);
            }
        }
    }
}
